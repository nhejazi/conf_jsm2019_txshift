...
% title info
\title{\normalsize Towards the Realistic, Robust, and Efficient Assessment of
  Causal Effects with Stochastic Shift Interventions}

\subtitle{\scriptsize Considerations for two-phase sampling designs,
  nonparametric variable importance analysis, and open source software
  implementations\\[-10pt]}
...
\note{This slide deck is for a seminar-length talk (about 50 minutes) on an
  ...
  examining HIV. This talk was most recently given as part of my PhD
  qualifying examination at the University of California, Berkeley.

  Source: \url{https://github.com/nhejazi/qualexam-phd-biostat} \\
  Slides: \url{http://bit.ly/2018_biostat_quals} \\
  With notes: \url{http://bit.ly/2018_biostat_quals_notes}
}
...
\begin{frame}[c]{Interlude: A Causal Inference Perspective}
